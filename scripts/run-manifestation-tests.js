const { ORACLE_CARDS } = require('../data/cards');
const { runIntelligenceEngine } = require('../intelligence');
...
// Test 2
console.log('Running Test 2: Love Conflict with High Fire & Yang Overload...');
